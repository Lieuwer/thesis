...
There are many parameters used by the different models. A parameter is either defined for every item or for every student and is displayed by one symbol. The value of a parameter for a particular student or item will be called parameter and is displayed by adding a subscript ($i$ for item and $s$ for student) to the symbol. All the instances of a specific parameter together is called a parameter-type. 
